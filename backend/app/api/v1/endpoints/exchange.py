...
# Инициализируем чекер ролей: разрешаем студентам, старостам, кураторам и админам
get_current_student = RoleChecker(allowed_roles=[UserRole.STUDENT, UserRole.LEADER, UserRole.CURATOR, UserRole.ADMIN])
