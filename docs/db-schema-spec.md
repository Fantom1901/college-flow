...
| Column        | Type    | Constraints                       | Description                      |
|---------------|---------|-----------------------------------|----------------------------------|
| id            | Integer | Primary Key                       | Уникальный ID запроса            |
...
3. **On Absence:** При записи 'absent' в посещаемость проверить, было ли у юзера дежурство. Если да — перенести дежурство на следующую свободную дату без увеличения веса.  
